...
**6. Connect a BI tool**
- Databricks SQL Dashboards connect natively to the SQL Warehouse — no external setup needed. Point any other SQL client at the same Warehouse connection details if preferred, and query the `gold_*` tables directly
